...
export const SEGMENT_STUDIO_SHORTCUTS = [
  ...
  { id: "video.frameLongBackward", category: "Playback", bindings: [{ key: ",", ctrl: true, label: "Ctrl+," }], description: "Step backward by the long frame count" },
  { id: "video.frameLongForward", category: "Playback", bindings: [{ key: ".", ctrl: true, label: "Ctrl+." }], description: "Step forward by the long frame count" },
