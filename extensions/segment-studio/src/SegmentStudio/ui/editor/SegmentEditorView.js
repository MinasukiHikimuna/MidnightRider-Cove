  ...
  const currentUndoAction = [...(history.actions || [])]
    ...
    return h("section", {
      ...
      incorrectExamplesOpen ? h(IncorrectExamplesDialog, {
        ...
        hidingFromReview: hideIncorrectExamples,
        removingExampleId,
        onExport: captureTrainingExport,
        onToggleReviewVisibility: () => setHideIncorrectExamples((current) => !current),
