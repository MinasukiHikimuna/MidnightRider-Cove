...
{
    private const string ApiBase = "/api/extensions/com.midnightrider.animated-tag-previews";
    ...
    public override UIManifest GetUIManifest()
        => ManifestBuilder()
            .AddSlot("media-player-actions", "AnimatedPreviewPlayerAction", "com.midnightrider.animated-tag-previews:player-action", 100)
            .AddSlot("media-player-overlay", "AnimatedPreviewPlayerOverlay", "com.midnightrider.animated-tag-previews:player-overlay", 100)
            .OverrideComponent("entity.media", "AnimatedTagMedia", 100)
            .AddSlot("entity-cover-editor", "AnimatedTagCoverEditor", "com.midnightrider.animated-tag-previews:cover-editor", 100)
            ...
            .AddSettingsSection(
                ...
                "com.midnightrider.animated-tag-previews:settings",
                100)
            .Build();
        ...
        CancellationToken ct)
    {
        ...
        await audit.LogAsync(AuditActions.SettingsChange, AuditOutcomes.Success, principals.Current,
            "extension", "com.midnightrider.animated-tag-previews", new { settings = "com.midnightrider.animated-tag-previews" }, ct);
        ...
        CancellationToken ct)
    {
        ...
        await audit.LogAsync("animated_preview.orphan_cleanup", AuditOutcomes.Success, principals.Current,
            "extension", "com.midnightrider.animated-tag-previews", new { dryRun, result.Count, result.StalePreviewRecordCount, result.StalePreviewCandidateCount, result.ExpiredApprovalReceiptCount, result.DeletedBlobCount, failed = result.FailedBlobIds.Count },
