...
const errors = [];
const required = ["extension.json", "README.md", "LICENSE", "AuthMiddleware.dll", "dist/ui.mjs", "dist/ui.css"];
...
if (fs.existsSync(manifestPath)) {
  ...
  if (manifest.entryDll !== "AuthMiddleware.dll") errors.push("manifest entryDll is incorrect");
