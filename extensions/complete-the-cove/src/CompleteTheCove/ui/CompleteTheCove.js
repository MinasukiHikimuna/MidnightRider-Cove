...
function MissingScenesPage({ onNavigate }) {
  ...
  return h("div", { className: "mx-auto max-w-[1800px]" }, [
    ...
    h("div", { key: "tabs", className: "complete-the-cove-tabs border-border", role: "tablist", "aria-label": "Missing Scenes views" }, [
      ...
      h("button", { key: "tracked", id: "complete-the-cove-tab-tracked", type: "button", role: "tab", "aria-selected": location.view === "tracked", "aria-controls": "complete-the-cove-panel", tabIndex: location.view === "tracked" ? 0 : -1, onKeyDown: handleTabKey, onClick: () => navigateCatalog({ view: "tracked", targetType: null, targetId: null }), className: `complete-the-cove-tab ${location.view === "tracked" ? "complete-the-cove-tab-active" : ""}` }, ["Tracked Records", !overviewLoading ? h("span", { key: "count", className: "complete-the-cove-tab-count" }, overview.totals.all.toLocaleString()) : null]),
    ]),
