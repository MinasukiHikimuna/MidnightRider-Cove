...
public sealed class TrustedHeaderAuthenticatorTests
{
    ...
    {
        var settings = ExternalSignInSettings.Default with
        {
        ...
        Assert.Equal(ExternalSignInExtension.ExtensionId, assertion.ExtensionId);
    ...
    private sealed class FixedSettings(ExternalSignInSettings settings) : IExternalSignInSettingsProvider
    {
        public ExternalSignInSettings Current => settings;
    }
}
