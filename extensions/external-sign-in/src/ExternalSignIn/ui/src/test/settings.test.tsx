...
import {
  ...
  type ExternalSignInSettings,
} from "../api";
import { ExternalSignInSettings as SettingsComponent } from "../settings";

const configured: ExternalSignInSettings = {
  ...DEFAULT_SETTINGS,
...
describe("external sign-in settings", () => {
  ...
  it("adds a provider without choosing its persistent ID in the browser", async () => {
    let savedBody: Record<string, any> | undefined;
    const savedWithGeneratedProvider: ExternalSignInSettings = {
      ...DEFAULT_SETTINGS,
      covePublicUrl: "https://cove.example.invalid",
      oidcProviders: [
        {
