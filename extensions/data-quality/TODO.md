...
- [ ] Enable editing from the review view and returning to the same position.
...
- [ ] Extract the proven workflow behind narrow, reusable Cove extension interfaces.
- [ ] Package and verify an installable extension through Cove's live UI.
- [ ] Persist review configuration per account across browsers.
- [ ] Migrate existing prototype reviews without losing local edits or imported configuration.
...
- [ ] Verify large queues, keyboard conflicts, permissions, partial failures, and changing results.
- [ ] Compare real review workflows with Culture and resolve remaining interaction friction.
- [ ] Complete relevant automated and live-UI verification and final code review.
- [ ] Remove the old sidebar after the replacement and migration are verified.
