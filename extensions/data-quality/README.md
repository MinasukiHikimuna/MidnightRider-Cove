...
Registry publication and its final compatibility floor remain deferred. Visual-similarity searches are unavailable through the public extension API. Multi-step actions use existing authorized operations and can partially succeed; atomic actions and undo remain a separate backend milestone.
