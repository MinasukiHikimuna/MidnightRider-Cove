...
Normal video reviews also support **Review layout → Multiple videos**, with Grid/Wall cards, multi-selection, action shortcuts, and quick previews. **Edit review → Appearance → Preferred review layout** saves the default for that rule. Existing rules keep single-video review until a different preference is saved; occurrence reviews retain their performer-specific workspace.
